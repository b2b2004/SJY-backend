...
public class SopBoardController {
    ...
    @PostMapping("/sopBoard/recruitrefuse")
    public ResponseEntity<?> refuseMember(@RequestBody RecruitMsg rm)
    {
        return new ResponseEntity<>(sopBoardService.맴버거절(rm), HttpStatus.OK);
    }
